...
#define CONFIGURE_LINE "./configure  '--disable-dbus' '--disable-mad' '--disable-avcodec' '--disable-avformat' '--disable-postproc' '--disable-a52' '--disable-glx' '--disable-fribidi' '--disable-qt4' '--disable-skins2' '--disable-nls' '--disable-mozilla' '--disable-lua' '--disable-swscale' '--disable-xcb' '--disable-alsa'"
...
#define PACKAGE_STRING "vlc 3.0.9"
...
#define PACKAGE_VERSION_REVISION 9
...
#define VERSION_MESSAGE "3.0.9 Vetinari"

/* compiler */
#define VLC_COMPILER "gcc version 8.3.0 (Debian 8.3.0-6)"

/* user who ran configure */
#define VLC_COMPILE_BY "videolan"

/* host which ran configure */
#define VLC_COMPILE_HOST "www"
