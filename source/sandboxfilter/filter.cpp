...
#endif
#define MODULE_STRING "sandboxfilter"
//const char vlc_module_name[] = "sepiafilter";
...
#define COLOR_LONGTEXT ("Colors similar to this will be kept, others will be "\
    "grayscaled. This must be an hexadecimal (like HTML colors). The first two "\
    "chars are for red, then green, then blue. #000000 = black, #FF0000 = red,"\
    " #00FF00 = green, #FFFF00 = yellow (red + green), #FFFFFF = white" )
#define COLOR_HELP ("Select one color in the video")
...
vlc_module_begin()
	...
	add_rgb(CFG_PREFIX "color", 0x00FF0000, COLOR_TEXT, COLOR_LONGTEXT, false)
...
static int Create(vlc_object_t *p_this)
{
	...
	p_sys = (filter_sys_t*)p_filter->p_sys;
...
static picture_t *Filter(filter_t *p_filter, picture_t *p_pic)
{
	...
	sprintf((char*)p_shareddata, "hello");
